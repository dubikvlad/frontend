...
export const PickByMembersTheadList: TheadData<'xrun_mlb_picks_by_members'> = {
  'entry.color': {
    title: '',
  },
  name: {
...
): TBodyRowData<'xrun_mlb_picks_by_members'>[] {
  return data
    ...
    .map(
      (
        ...
        const runs = Object.entries(entry.xrun_mlb_forecast).filter(
          ([key, _]) => key.startsWith('count_run_'),
        )
